...
import com.skplanet.nlp.data.MovieLensUser;
...
/**
 * Matrices Reader for MovieLens Dataset
 * @author Donghun Shin / donghun.shin@sk.com
 * @date 12/24/15
 */
public class MovieLensMatrixReader extends AbstractMatrixReader {
    // logger
    private static final Logger LOGGER = Logger.getLogger(MovieLensMatrixReader.class.getName());
     ...
     */
    public MovieLensMatrixReader(String userInfoPath, String itemInfoPath, String ratingPath) {
    ...
    public void loadUserInfo() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (fields.length != 5) {
                    LOGGER.warn("user information field must be 5: " + line);
                    continue;
                }
    ...
    public void loadItemInfo() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (fields.length != 24) {
                    LOGGER.warn("item information field must be 24: " + line);
                    continue;
                }
                ...
                String vidReleaseDate = fields[3];
